      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{
            ...
            background: '#2383e2', display: 'flex',
        ...
        <p style={{ fontSize: 12, color: '#9b9b9b' }}>
          © 2024 DriftBox · Built with ❤️ by BitGladiator
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{ width: '100%', maxWidth: 360 }}>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  border: `1.5px solid ${focusedField === 'email' ? '#2383e2' : '#e8e8e6'}`,
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{
                    ...
                    borderRadius: 10, fontSize: 14,
                    border: `1.5px solid ${focusedField === 'password' ? '#2383e2' : '#e8e8e6'}`,
                    background: '#f7f6f3', color: '#1a1a1a',
                    outline: 'none', transition: 'border-color 0.15s',
                    boxSizing: 'border-box',
                  }}
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer', color: '#9b9b9b', padding: 0,
                  }}
                >
            ...
            <button
              ...
              style={{
                ...
                background: loading ? '#93c5fd' : '#2383e2',
          ...
          <p style={{ fontSize: 13, textAlign: 'center', color: '#6b6b6b' }}>
            ...
            <Link href="/signup" style={{ color: '#2383e2', fontWeight: 600, textDecoration: 'none' }}>
              Create one free
            </Link>
          </p>
        </div>
