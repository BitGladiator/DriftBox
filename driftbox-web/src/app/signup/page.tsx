  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'Sora', sans-serif" }}>
      ...
      <div style={{ width: 460, flexShrink: 0, background: '#f7f6f3', borderRight: '1px solid #e8e8e6', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '48px 40px' }}>
        ...
        <div>
          <p style={{ fontSize: 12, fontWeight: 600, color: '#9b9b9b', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 24 }}>What you get</p>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40, background: '#ffffff' }}>
        <div style={{ width: '100%', maxWidth: 360, animation: 'fadeIn 0.3s ease' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input type={showPass ? 'text' : 'password'} value={password} required placeholder="Min. 8 characters"
            ...
            <div>
              ...
              <input type="password" value={confirm} required placeholder="Repeat your password"
            ...
            <button type="submit" disabled={loading}
              style={{ width: '100%', padding: '11px 20px', borderRadius: 10, fontSize: 14, fontWeight: 600, background: loading ? '#93c5fd' : '#2383e2', color: 'white', border: 'none', cursor: loading ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 4 }}>
          ...
          <p style={{ fontSize: 13, textAlign: 'center', color: '#6b6b6b' }}>
            ...
            <Link href="/login" style={{ color: '#2383e2', fontWeight: 600 }}>Sign in</Link>
          </p>
        </div>
      </div>
